...
CREATE TABLE "MEMBER" (
	...
	"ENROLL_DATED"	DATE	DEFAULT SYSDATE	NOT NULL,
...
COMMENT ON COLUMN "MEMBER"."ENROLL_DATED" IS '회원 가입일';
...
COMMENT ON COLUMN "BOARD"."BOARD_DEL_FL" IS '삭제 여부(N : 삭제X, Y : 삭제 O)';
...
INSERT INTO BOARD_TYPE VALUES(SEQ_BOARD_CODE.NEXTVAL, '데스트 게시판');
...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!',
		'유저이', '01022222222', '04540,,서울시 중구 남대문로 120,,3층',
		DEFAULT, DEFAULT, DEFAULT, DEFAULT
);
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME,
		...
		TO_CHAR(ENROLL_DATED, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENROLL_DATE
FROM "MEMBER"
...
UPDATE "MEMBER" SET
MEMBER_PW='$2a$10$My843Q6fs815euRUaahF9OFZx4XTvRaiTaVNPnjNF0yjS3WnPjY66'
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_ADDRESS, 
	   MEMBER_DEL_FL,
	   TO_CHAR( ENROLL_DATED, 'YYYY"년" MM"월" DD"일"') ENROLL_DATE
FROM "MEMBER"
...
UPDATE BOARD_IMG SET BOARD_NO ='1982' WHERE BOARD_NO =1998;
UPDATE BOARD_IMG SET BOARD_NO ='1980' WHERE BOARD_NO =1995;
UPDATE BOARD_IMG SET BOARD_NO ='1978' WHERE BOARD_NO =1990;
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00002.gif', '2.gif', 1 , 1985);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00003.gif', '3.gif', 2 , 1985);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00004.gif', '4.gif', 3 , 1985);
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 1985, 12, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1985, 10, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 1985, 2, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 1985, 6, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 1985, 12, 2001);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 1985, 10, 2002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 1985, 5, 2002);
COMMIT;
...
UPDATE BOARD SET READ_COUNT = READ_COUNT+1 WHERE BOARD_NO=1985;

SELECT READ_COUNT FROM BOARD WHERE BOARD_NO=1985;
...
INSERT INTO "BOARD_LIKE" VALUES(1985,9);
...
SELECT '경로2' IMG_PATH,
		...
		'이미지 순서2' IMG_IMG_ORDER,
		'게시글 번호2' BOARD_NO
FROM DUAL) A
UNION ALL
SELECT '경로3' IMG_PATH,
		'변경된 파일3' IMG_RENAME,
		'원본 파일명3' IMG_ORIGINAL,
		'이미지 순서3' IMG_IMG_ORDER,
		'게시글 번호3' BOARD_NO
FROM DUAL;
